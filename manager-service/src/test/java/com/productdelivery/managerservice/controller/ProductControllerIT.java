...
class ProductControllerIT {
    ...
    void getProduct_ProductExists_ReturnsProductPage() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/catalog/products/1")
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        status().isOk(),
                        view().name("catalog/products/product"),
    ...
    void getProductEditPage_ProductExists_ReturnsProductEditPage() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/catalog/products/1/edit")
                .with(user("UserManager").roles("MANAGER"));
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        status().isOk(),
                        view().name("catalog/products/edit"),
                        model().attribute("product", new Product(1, "Товар", "Описание товара"))
                );
    }
    ...
    void updateProduct_RequestIsValid_RedirectsToProductPage() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.post("/catalog/products/1/edit")
        ...
        WireMock.stubFor(WireMock.patch("/catalog-api/products/1")
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        ...
                        redirectedUrl("/catalog/products/1")
                );

        WireMock.verify(WireMock.patchRequestedFor(WireMock.urlPathMatching("/catalog-api/products/1"))
                .withRequestBody(WireMock.equalToJson("""
                        {
                            "title": "Новое название",
                            "details": "Новое описание товара"
    ...
    void deleteProduct_ProductExists_RedirectsToProductsListPage() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.post("/catalog/products/1/delete")
                .with(user("UserManager").roles("MANAGER"))
                .with(csrf());
        ...
        WireMock.stubFor(WireMock.delete("/catalog-api/products/1")
                .willReturn(WireMock.noContent()));
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        status().is3xxRedirection(),
                        redirectedUrl("/catalog/products/list")
                );

        WireMock.verify(WireMock.deleteRequestedFor(WireMock.urlPathMatching("/catalog-api/products/1")));
    }
