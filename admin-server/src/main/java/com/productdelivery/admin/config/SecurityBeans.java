package com.productdelivery.admin.config;

import com.productdelivery.admin.web.client.OAuthHttpHeadersProvider;
...
public class SecurityBeans {
    ...
    /**
     * The SecurityFilterChain for registering services in Admin-Service
     * */
    @Bean
    @Priority(0)
    ...
    /**
     * The SecurityFilterChain for the user's access to the Admin-Service
     * */
    @Bean
    @Priority(1)
